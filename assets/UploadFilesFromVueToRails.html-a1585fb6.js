import{_ as t,M as e,p,q as i,R as n,t as a,N as o,a1 as l}from"./framework-96b046e1.js";const c={},u=l(`<h1 id="upload-files-from-vue-js-to-rails-with-activestorage" tabindex="-1"><a class="header-anchor" href="#upload-files-from-vue-js-to-rails-with-activestorage" aria-hidden="true">#</a> Upload Files from Vue.js to Rails with ActiveStorage</h1><p>Simple enough, isn&#39;t it ? Well, no, but yes, but maybe I&#39;ll just be honest there and confess this took me way longer than I&#39;d love to admit.</p><p>The goal of the game is to create an Item from a Vue.js user form, and store it quietly in our Ruby on Rails API, using ActiveStorage. An item will have a name, description, and of course, the user-uploaded picture ! We&#39;re going to build a Vue.js component and the Rails controller. Let&#39;s dance !</p><h2 id="our-vue-js-form-component" tabindex="-1"><a class="header-anchor" href="#our-vue-js-form-component" aria-hidden="true">#</a> Our Vue.js Form Component</h2><h3 id="the-html-template" tabindex="-1"><a class="header-anchor" href="#the-html-template" aria-hidden="true">#</a> The HTML Template</h3><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The HTML part is simple enough. Make sure to add that <code>enctype=&quot;multipart/form-data&quot;</code>. Another possibility is to just add <code>Content-Type: multipart/form-data</code> to the header of our javascript POST request. But I prefer adding complexity to HTML instead.</p><p>Please also notice how we activate the function <code>uploadFile()</code> when a change is detected on the file upload button.</p><h3 id="the-javascript" tabindex="-1"><a class="header-anchor" href="#the-javascript" aria-hidden="true">#</a> The Javascript</h3><div class="language-Javascript line-numbers-mode" data-ext="Javascript"><pre class="language-Javascript"><code>
export default {
  name: &#39;itemsForm&#39;,
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>No black magic there, everything is simple. We iterate over the params to add them to a FormData object, then we send it.</p><h2 id="our-rails-controller" tabindex="-1"><a class="header-anchor" href="#our-rails-controller" aria-hidden="true">#</a> Our Rails Controller</h2><div class="language-ruby line-numbers-mode" data-ext="rb"><pre class="language-ruby"><code><span class="token keyword">class</span> <span class="token class-name">ItemsController</span> <span class="token operator">&lt;</span> ApplicationController
  ...
  <span class="token keyword">end</span>
<span class="token keyword">end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Don&#39;t forget to add <code>post &#39;items&#39; =&gt; &#39;items#create&#39;</code> to your Rails routes. You might also need to deactivate the parameter wrapping in the initializers.</p><h2 id="what-else-to-do" tabindex="-1"><a class="header-anchor" href="#what-else-to-do" aria-hidden="true">#</a> What else to do ?</h2><p>I kept the code simple there, but obviously you should add validations in the controller, both on size and file types. You don&#39;t want just any crap taking all your precious server space !</p>`,16),r={href:"https://scotch.io/tutorials/how-to-handle-file-uploads-in-vue-2",target:"_blank",rel:"noopener noreferrer"};function d(m,v){const s=e("ExternalLinkIcon");return p(),i("div",null,[u,n("p",null,[a("If you want multiple file upload, "),n("a",r,[a("Check out this link !"),o(s)])])])}const b=t(c,[["render",d],["__file","UploadFilesFromVueToRails.html.vue"]]);export{b as default};
